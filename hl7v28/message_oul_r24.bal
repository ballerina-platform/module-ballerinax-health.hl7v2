...
@hl7v2:MessageDefinition {
    orderedSegments: {
        ...
        "NTE": [
                ...
                },
                {
                        ...
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "OUL_R24_ORDER.OUL_R24_RESULT"
                }
        ],
        "PID": [
                {
        ...
        "PRT": [
                ...
                },
                {
                        ...
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "OUL_R24_ORDER.OUL_R24_COMMON_ORDER"
                },
                {
                        "name": "PRT",
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "OUL_R24_ORDER.OUL_R24_COMMON_ORDER.OUL_R24_ORDER_DOCUMENT"
                },
                {
                        "name": "PRT",
                        "maxReps": -1,
        ...
        "SAC": [
                {
                        ...
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "OUL_R24_ORDER.OUL_R24_SPECIMEN.OUL_R24_CONTAINER"
                }
        ],
        "INV": [
                {
    ...
    groups: {
        ...
        "OUL_R24_ORDER.OUL_R24_COMMON_ORDER": {
                "maxReps": 1,
                "required": false,
                "segments": {
                        "ORC": {
        ...
        "OUL_R24_ORDER.OUL_R24_COMMON_ORDER.OUL_R24_ORDER_DOCUMENT": {
                "maxReps": 1,
                "required": false,
                "segments": {
                        "OBX": {
        ...
        "OUL_R24_ORDER.OUL_R24_SPECIMEN.OUL_R24_CONTAINER": {
                "maxReps": -1,
                "required": false,
                "segments": {
                        "SAC": {

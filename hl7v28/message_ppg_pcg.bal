...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPG_PCG_PATHWAY.PPG_PCG_GOAL.PPG_PCG_ORDER.PPG_PCG_ORDER_DETAIL.PPG_PCG_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPG_PCG_PATHWAY.PPG_PCG_GOAL.PPG_PCG_ORDER.PPG_PCG_ORDER_DETAIL.PPG_PCG_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

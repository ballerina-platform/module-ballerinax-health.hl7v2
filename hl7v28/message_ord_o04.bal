    ...
    ,groups: {
        "RESPONSE": {
            ...
            segments: {
                ...
                "ORDER_DIET": {name: "ORDER_DIET", maxReps: -1, required: false, segmentType: typeof ORDER_DIET},
                "ORDER_TRAY": {name: "ORDER_TRAY", maxReps: -1, required: false, segmentType: typeof ORDER_TRAY}
            }
        }
    }
}

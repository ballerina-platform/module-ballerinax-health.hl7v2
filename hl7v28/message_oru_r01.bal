...
@hl7v2:MessageDefinition {
    orderedSegments: {
        ...
        "PRT": [
                ...
                },
                {
                        ...
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "ORU_R01_PATIENT_RESULT.ORU_R01_ORDER_OBSERVATION.ORU_R01_COMMON_ORDER"
                },
                {
                        "name": "PRT",
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "ORU_R01_PATIENT_RESULT.ORU_R01_ORDER_OBSERVATION.ORU_R01_COMMON_ORDER.ORU_R01_ORDER_DOCUMENT"
                },
                {
                        "name": "PRT",
                        "maxReps": -1,
    ...
    groups: {
        ...
        "ORU_R01_PATIENT_RESULT.ORU_R01_ORDER_OBSERVATION.ORU_R01_COMMON_ORDER": {
                "maxReps": 1,
                "required": false,
                "segments": {
                        "ORC": {
        ...
        "ORU_R01_PATIENT_RESULT.ORU_R01_ORDER_OBSERVATION.ORU_R01_COMMON_ORDER.ORU_R01_ORDER_DOCUMENT": {
                "maxReps": 1,
                "required": false,
                "segments": {
                        "OBX": {

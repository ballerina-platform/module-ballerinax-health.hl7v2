...
# + al1 - AL1
# + nte - NTE
# + authorization_1 - RPA_I11_AUTHORIZATION_1 Segment Group
...
@hl7v2:MessageDefinition {
        ...
        "AUT": [
                {
                        ...
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "RPA_I11_AUTHORIZATION_1"
                },
                {
                        "name": "AUT",
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "RPA_I11_PROCEDURE.RPA_I11_AUTHORIZATION_2"
                }
        ],
        "CTD": [
                {
    ...
    groups: {
        ...
        "RPA_I11_PROCEDURE.RPA_I11_AUTHORIZATION_2": {
                "maxReps": 1,
                "required": false,
                "segments": {
                        "AUT": {
...
public type RPA_I11 record {
    *hl7v2:Message;
    ...
    AL1[] al1 = [];
    NTE[] nte = [];
    RPA_I11_AUTHORIZATION_1 authorization_1?;

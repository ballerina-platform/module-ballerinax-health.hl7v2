...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPR_PC1_PROBLEM.PPR_PC1_ORDER.PPR_PC1_ORDER_DETAIL.PPR_PC1_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPR_PC1_PROBLEM.PPR_PC1_ORDER.PPR_PC1_ORDER_DETAIL.PPR_PC1_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

...
# + arv - ARV
# + gt1 - GT1
# + patient_visit - VXU_V04_PATIENT_VISIT Segment Group
# + insurance - VXU_V04_INSURANCE Segment Group
# + person_observation - VXU_V04_PERSON_OBSERVATION Segment Group
    ...
    orderedSegments: {
        ...
        "ARV": [
                ...
                },
                {
                        ...
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "VXU_V04_PATIENT_VISIT"
                }
        ],
        "PV1": [
                {
        ...
        "OBX": [
                {
                        ...
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "VXU_V04_PERSON_OBSERVATION"
                },
                {
                        "name": "OBX",
                        "maxReps": 1,
        ...
        "TQ1": [
                {
                        ...
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "VXU_V04_ORDER.VXU_V04_TIMING"
                }
        ],
        "TQ2": [
                {
...
public type VXU_V04 record {
    *hl7v2:Message;
    ...
    ARV[] arv = [];
    GT1[] gt1 = [];
    VXU_V04_PATIENT_VISIT patient_visit?;
    VXU_V04_INSURANCE[] insurance = [{in1: {}}];
    VXU_V04_PERSON_OBSERVATION[] person_observation = [{obx: {}}];
    VXU_V04_ORDER[] 'order = [{orc: {}, rxa: {}}];
};

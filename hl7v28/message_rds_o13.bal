...
@hl7v2:MessageDefinition {
        ...
        "PD1": [
                {
                        ...
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "RDS_O13_PATIENT.RDS_O13_ADDITIONAL_DEMOGRAPHICS"
                }
        ],
        "PRT": [
                {
        ...
        "TQ1": [
                {
                        ...
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "RDS_O13_ORDER.RDS_O13_TIMING"
                },
                {
                        "name": "TQ1",
                        "maxReps": 1,
                        "required": true,
                        "segmentComponentName": "RDS_O13_ORDER.RDS_O13_ENCODING.RDS_O13_TIMING_ENCODED"
                }
        ],
        "TQ2": [
                {
    ...
    groups: {
        ...
        "RDS_O13_PATIENT.RDS_O13_ADDITIONAL_DEMOGRAPHICS": {
                "maxReps": 1,
                "required": false,
                "segments": {
                        "PD1": {
        ...
        "RDS_O13_ORDER.RDS_O13_ENCODING.RDS_O13_TIMING_ENCODED": {
                "maxReps": -1,
                "required": true,
                "segments": {
                        "TQ1": {

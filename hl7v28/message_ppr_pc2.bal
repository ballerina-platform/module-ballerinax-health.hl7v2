...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPR_PC2_PROBLEM.PPR_PC2_ORDER.PPR_PC2_ORDER_DETAIL.PPR_PC2_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPR_PC2_PROBLEM.PPR_PC2_ORDER.PPR_PC2_ORDER_DETAIL.PPR_PC2_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

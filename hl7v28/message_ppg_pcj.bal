...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPG_PCJ_PATHWAY.PPG_PCJ_GOAL.PPG_PCJ_ORDER.PPG_PCJ_ORDER_DETAIL.PPG_PCJ_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPG_PCJ_PATHWAY.PPG_PCJ_GOAL.PPG_PCJ_ORDER.PPG_PCJ_ORDER_DETAIL.PPG_PCJ_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

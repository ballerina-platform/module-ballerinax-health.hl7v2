...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPP_PCB_PATHWAY.PPP_PCB_PROBLEM.PPP_PCB_ORDER.PPP_PCB_ORDER_DETAIL.PPP_PCB_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPP_PCB_PATHWAY.PPP_PCB_PROBLEM.PPP_PCB_ORDER.PPP_PCB_ORDER_DETAIL.PPP_PCB_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

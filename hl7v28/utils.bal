...
if segmentComponentName == "RPR_I03_PROVIDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "SDR_S31_ANTI_MICROBIAL_DEVICE_DATA" {
    ...
    return messageInstance;
} else if segmentComponentName == "SDR_S32_ANTI_MICROBIAL_DEVICE_CYCLE_DATA" {
    ...
    return messageInstance;
} else if segmentComponentName == "CQU_I19_PATIENT" {
...
if segmentComponentName == "CCM_I21_INSURANCE" {
    CCM_I21_INSURANCE messageInstance = {in1:{}};
    return messageInstance;
} else if segmentComponentName == "RSP_K11_SEGMENT_PATTERN" {
    ...
    return messageInstance;
} else if segmentComponentName == "QBP_Q11_QBP" {
    ...
    return messageInstance;
} else if segmentComponentName == "REF_I12_AUTHORIZATION_CONTACT2" {
    ...
    return messageInstance;
} else if segmentComponentName == "OPL_O37_OBSERVATION_RESULT_GROUP" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORU_R01_SPECIMEN_OBSERVATION" {
    ...
    return messageInstance;
} else if segmentComponentName == "RRI_I12_AUTHORIZATION_CONTACT2" {
    ...
    return messageInstance;
} else if segmentComponentName == "RPA_I08_AUTHORIZATION2" {
...
if segmentComponentName == "RQA_I08_AUTHORIZATION2" {

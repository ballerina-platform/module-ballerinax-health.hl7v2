...
isolated function getMessage(string messageName) returns hl7v2:Message? {
    match messageName {
        ...
        "MDM_T03" => {
            MDM_T03 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T04" => {
            MDM_T04 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T05" => {
            MDM_T05 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T06" => {
            MDM_T06 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T07" => {
            MDM_T07 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T08" => {
            MDM_T08 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T09" => {
            MDM_T09 messageInstance = {msh: {}};
            return messageInstance;
        }
        "MDM_T10" => {
            MDM_T10 messageInstance = {msh: {}};
            return messageInstance;
        }
        "EHC_E12" => {

...
# + obr - OBR
# + nte - NTE
# + patient_observation - ORU_R32_PATIENT_OBSERVATION Segment Group
    ...
    orderedSegments: {
        ...
        "PRT": [
                ...
                },
                {
                        ...
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "ORU_R32_PATIENT_OBSERVATION"
                },
                {
                        "name": "PRT",
                        "maxReps": -1,
...
public type ORU_R32 record {
    *hl7v2:Message;
    ...
    OBR obr;
    NTE[] nte = [];
    ORU_R32_PATIENT_OBSERVATION[] patient_observation = [{obx: {}}];
    ORU_R32_VISIT visit?;

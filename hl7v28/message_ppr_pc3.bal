...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPR_PC3_PROBLEM.PPR_PC3_ORDER.PPR_PC3_ORDER_DETAIL.PPR_PC3_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPR_PC3_PROBLEM.PPR_PC3_ORDER.PPR_PC3_ORDER_DETAIL.PPR_PC3_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

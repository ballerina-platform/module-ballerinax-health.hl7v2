...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPP_PCD_PATHWAY.PPP_PCD_PROBLEM.PPP_PCD_ORDER.PPP_PCD_ORDER_DETAIL.PPP_PCD_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPP_PCD_PATHWAY.PPP_PCD_PROBLEM.PPP_PCD_ORDER.PPP_PCD_ORDER_DETAIL.PPP_PCD_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

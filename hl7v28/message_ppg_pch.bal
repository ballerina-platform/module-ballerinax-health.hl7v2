...
@hl7v2:MessageDefinition {
        ...
        "OBR": [
                {
                        ...
                        "maxReps": 1,
                        "required": false,
                        "segmentComponentName": "PPG_PCH_PATHWAY.PPG_PCH_GOAL.PPG_PCH_ORDER.PPG_PCH_ORDER_DETAIL.PPG_PCH_CHOICE"
                }
        ],
        "Hxx": [
                {
    ...
    groups: {
        ...
        "PPG_PCH_PATHWAY.PPG_PCH_GOAL.PPG_PCH_ORDER.PPG_PCH_ORDER_DETAIL.PPG_PCH_CHOICE": {
                "maxReps": 1,
                "required": true,
                "segments": {
                        "OBR": {

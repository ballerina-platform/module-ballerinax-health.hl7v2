...
@hl7v2:MessageDefinition {
    orderedSegments: {
        ...
        "PRT": [
                ...
                },
                {
                        ...
                        "maxReps": -1,
                        "required": false,
                        "segmentComponentName": "RRA_O18_RESPONSE.RRA_O18_ORDER.RRA_O18_ADMINISTRATION.RRA_O18_TREATMENT"
                }
        ],
        "TQ1": [
                {
    ...
    groups: {
        ...
        "RRA_O18_RESPONSE.RRA_O18_ORDER.RRA_O18_ADMINISTRATION.RRA_O18_TREATMENT": {
                "maxReps": -1,
                "required": true,
                "segments": {
                        "RXA": {
...
public type RRA_O18 record {
    *hl7v2:Message;
    string name = RRA_O18_MESSAGE_TYPE;
    MSH msh;
    MSA msa;
    ERR[] err = [];
    SFT[] sft = [];

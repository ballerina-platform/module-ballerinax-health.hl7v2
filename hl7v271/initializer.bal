...
final handle packageModule = hl7v2:newModule(java:fromString("ballerinax"), java:fromString("health.hl7v271"), java:fromString("4"));

function init() {
    readonly & hl7v2:HL7Package package = {
        name: "HL7v271",
        hl7Version: "2.7.1",
        parserCreator: createHL7v271Parser,
        encoderCreator: createHL7v271Encoder,
        parserUtils: {
    ...
    log:printDebug("HL7 v2.7.1 Package Initialized");
}

# Function to create hl7v2:Parser implementation for HL7 v2.7.1.
...
public isolated function createHL7v271Parser() returns hl7v2:Parser {
    HL7v271Parser parser = new();
    return parser;
}
...
public isolated function createHL7v271Encoder() returns hl7v2:Encoder {
    HL7v271Encoder encoder = new();
    return encoder;
}
...
if segmentComponentName == "ADT_A06_PROCEDURE" {
    ...
    return messageInstance;
} else if segmentComponentName == "OSR_Q06_OBSERVATION" {
    ...
    return messageInstance;
} else if segmentComponentName == "RRE_O02_ENCODING" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORS_O02_ORDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "RRE_O02_PATIENT" {
...
if segmentComponentName == "RQA_I08_VISIT" {
    ...
    return messageInstance;
} else if segmentComponentName == "NMD_N02_APP_STATS" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORS_O02_RESPONSE" {
...
if segmentComponentName == "PRR_PC5_CHOICE" {
    ...
    return messageInstance;
} else if segmentComponentName == "PTR_PCF_CHOICE" {
    ...
    return messageInstance;
} else if segmentComponentName == "ADR_A19_INSURANCE" {

...
final handle packageModule = hl7v2:newModule(java:fromString("ballerinax"), java:fromString("health.hl7v231"), java:fromString("4"));

function init() {
    readonly & hl7v2:HL7Package package = {
        name: "HL7v231",
        hl7Version: "2.3.1",
        parserCreator: createHL7v231Parser,
        encoderCreator: createHL7v231Encoder,
        parserUtils: {
    ...
    log:printDebug("HL7 v2.3.1 Package Initialized");
}

# Function to create hl7v2:Parser implementation for HL7 v2.3.1.
...
public isolated function createHL7v231Parser() returns hl7v2:Parser {
    HL7v231Parser parser = new();
    return parser;
}
...
public isolated function createHL7v231Encoder() returns hl7v2:Encoder {
    HL7v231Encoder encoder = new();
    return encoder;
}
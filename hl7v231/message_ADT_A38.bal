...
public const ADT_A38_MESSAGE_TYPE = "ADT_A38";
...
@hl7v2:MessageDefinition {
    segments: {
        ...
        "DRG": {name: "DRG", maxReps: 1, required: true, segmentType: DRG}
    }
}
public type ADT_A38 record {
    *hl7v2:Message;
    string name = ADT_A38_MESSAGE_TYPE;
    MSH msh;
    EVN evn;
    PID pid;
    PD1 pd1?;

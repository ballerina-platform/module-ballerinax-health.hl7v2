...
# + err - ERR Segment
# + nte - NTE Segment
# + response - RRD_O02_RESPONSE Segment Group
@hl7v2:MessageDefinition {
    ...
    ,groups: {
        "RRD_O02_RESPONSE": {
            ...
            required: false,
            segments: {
                "RRD_O02_PATIENT": {name: "RRD_O02_PATIENT", maxReps: 1, required: false, segmentType: typeof RRD_O02_PATIENT},

...
isolated function getSegmentComponent(string segmentComponentName) returns hl7v2:SegmentComponent? {
    match segmentComponentName {
        ...
        "QUERY_RESULT_CLUSTER" => {
            QUERY_RESULT_CLUSTER messageInstance = {};
            return messageInstance;
        }
        "OBSERVATION" => {
        ...
        "ANTIMICROBIAL_DEVICE_DATA" => {
            ANTIMICROBIAL_DEVICE_DATA messageInstance = {};
            return messageInstance;
        }
        "SCHEDULE" => {
        ...
        "CLOCK_AND_STATISTICS" => {
            CLOCK_AND_STATISTICS messageInstance = {};
            return messageInstance;
        }
        ...
        "ORDER_OBSERVATION" => {
            ORDER_OBSERVATION messageInstance = {};
            return messageInstance;
        }
        "PATIENT_VISIT" => {
        ...
        "ANTIMICROBIAL_DEVICE_CYCLE_DATA" => {
            ANTIMICROBIAL_DEVICE_CYCLE_DATA messageInstance = {};
            return messageInstance;
        }
        "ROW_DEFINITION" => {
        ...
        "QRY_WITH_DETAIL" => {
            QRY_WITH_DETAIL messageInstance = {};
            return messageInstance;
        }
        ...
        "MF_QUERY" => {
            MF_QUERY messageInstance = {};
            return messageInstance;
        }
        "MF_TEST" => {
            MF_TEST messageInstance = {};
            return messageInstance;
        }
        "CLOCK_AND_STATS_WITH_NOTES_ALT" => {
            CLOCK_AND_STATS_WITH_NOTES_ALT messageInstance = {};
            return messageInstance;
        }
        "GUARANTOR" => {

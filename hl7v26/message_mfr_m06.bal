    ...
    ,groups: {
        "MFR_M06_MF_QUERY": {
            ...
            segments: {
                ...
                "MFR_M06_MF_PHASE_SCHED_DETAIL": {name: "MFR_M06_MF_PHASE_SCHED_DETAIL", maxReps: -1, required: false, segmentType: typeof MFR_M06_MF_PHASE_SCHED_DETAIL}
            }
        }
    }
}
public type MFR_M06 record {
    *hl7v2:Message;
    ...
    MFI mfi;
    DSC dsc?;
    MFR_M06_MF_QUERY[] mf_query = [{mfe:{}, cm0:{}}];
};
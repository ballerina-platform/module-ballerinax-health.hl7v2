...
final handle packageModule = hl7v2:newModule(java:fromString("ballerinax"), java:fromString("health.hl7v27"), java:fromString("4"));
...
function init() {
    ...
    log:printDebug("HL7 v2.7 Package Initialized");
}

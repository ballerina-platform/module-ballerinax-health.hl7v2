...
This Module holds the messages, segments and data types for the HL7 version [2.7](https://www.hl7.org/implement/standards/product_brief.cfm?product_id=146).
    ...
    remote function onBytes(tcp:Caller caller, readonly & byte[] data) returns tcp:Error? {
        ...
        hl7v27:ACK ack = {
            msh: {
                ...
                msh9: {"cm_msg1": hl7v27:ACK_MESSAGE_TYPE},

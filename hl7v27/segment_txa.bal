...
# + txa22 - Authentication Person, Time Stamp (set)
# + txa23 - Distributed Copies (Code and Name of Recipient(s) )
# + txa24 - Folder Assignment
# + txa25 - Document Title
# + txa26 - Agreed Due Date/Time

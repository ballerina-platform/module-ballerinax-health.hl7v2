...
if segmentComponentName == "RPR_I03_PROVIDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "OML_O21_ORDER_GENERAL" {
    ...
    return messageInstance;
} else if segmentComponentName == "RTB_Q13_ROW_DEFINITION" {
    ...
    return messageInstance;
} else if segmentComponentName == "QBP_Q13_QBP" {
    ...
    return messageInstance;
} else if segmentComponentName == "RGR_RGR_DEFINTION" {
...
if segmentComponentName == "RAR_RAR_ORDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "RSP_K13_ROW_DEFINITION" {
    ...
    return messageInstance;
} else if segmentComponentName == "OML_O21_CONTAINER_1" {
    ...
    return messageInstance;
} else if segmentComponentName == "OML_O21_CONTAINER_2" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORL_O22_GENERAL_ORDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "OMS_O05_PATIENT" {
    ...
    return messageInstance;
} else if segmentComponentName == "OMG_O19_PRIOR_RESULT" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORL_O22_CONTAINER" {
    ...
    return messageInstance;
} else if segmentComponentName == "OML_O21_OBSERVATION" {
    OML_O21_OBSERVATION messageInstance = {obx:{}};
    return messageInstance;
} else if segmentComponentName == "ORP_O10_RESPONSE" {
...
if segmentComponentName == "ORN_O08_RESPONSE" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORF_R04_RESPONSE" {
    ...
    return messageInstance;
} else if segmentComponentName == "OMG_O19_INSURANCE" {
    OMG_O19_INSURANCE messageInstance = {in1:{}};
    return messageInstance;
} else if segmentComponentName == "OMN_O07_PATIENT_VISIT" {
    ...
    return messageInstance;
} else if segmentComponentName == "RRE_O12_ENCODING" {
    ...
    return messageInstance;
} else if segmentComponentName == "RSP_Z88_PATIENT" {
    ...
    return messageInstance;
} else if segmentComponentName == "RSP_Z88_ORDER_ENCODED" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORN_O08_ORDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "RPI_I04_INSURANCE" {
    ...
    return messageInstance;
} else if segmentComponentName == "RRG_O16_RESPONSE" {
    ...
    return messageInstance;
} else if segmentComponentName == "RSP_Z82_ORDER_DETAIL" {
    ...
    return messageInstance;
} else if segmentComponentName == "OMG_O19_ORDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "ORR_O02_ORDER_DETAIL" {
    ORR_O02_ORDER_DETAIL messageInstance = {};
    return messageInstance;
} else if segmentComponentName == "RSP_Z90_COMMON_ORDER" {
    RSP_Z90_COMMON_ORDER messageInstance = {orc:{}, obr:{}};
    return messageInstance;
} else if segmentComponentName == "OMP_O09_OBSERVATION" {
...
if segmentComponentName == "CSU_C12_PATIENT" {
    ...
    return segmentInstance;
} else if segmentComponentName == "MFK_M07_MF_CLIN_STUDY_SCHED" {
    ...
    return segmentInstance;
} else if segmentComponentName == "MFK_M06_MF_CLIN_STUDY" {
    ...
    return segmentInstance;
} else if segmentComponentName == "MFR_M12_MF_QUERY" {
    ...
    return segmentInstance;
} else if segmentComponentName == "MFK_M05_MF_LOCATION" {
    ...
    return segmentInstance;
} else if segmentComponentName == "MFK_M04_MF_CDM" {

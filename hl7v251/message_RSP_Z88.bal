...
# + rcp - RCP Segment
# + dsc - DSC Segment
# + query_response - RSP_Z88_QUERY_RESPONSE Segment Group
@hl7v2:MessageDefinition {
    ...
    ,groups: {
        "RSP_Z88_QUERY_RESPONSE": {
            ...
            required: true,
            segments: {
                "RSP_Z88_PATIENT": {name: "RSP_Z88_PATIENT", maxReps: 1, required: false, segmentType: typeof RSP_Z88_PATIENT},
                "RSP_Z88_COMMON_ORDER": {name: "RSP_Z88_COMMON_ORDER", maxReps: -1, required: true, segmentType: typeof RSP_Z88_COMMON_ORDER}
            }
        }
    }
}

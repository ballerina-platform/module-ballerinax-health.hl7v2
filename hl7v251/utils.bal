...
if segmentComponentName == "RPR_I03_PROVIDER" {
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R24_PV1PV2_SUPPGRP" {
    OUL_R24_PV1PV2_SUPPGRP messageInstance = {pv1:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI_SUPPGRP" {
    OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI_SUPPGRP messageInstance = {spm:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "ORF_R04_PIDNTEORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP" {
    ORF_R04_PIDNTEORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R23_TQ1TQ2_SUPPGRP" {
    OUL_R23_TQ1TQ2_SUPPGRP messageInstance = {tq1:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R24_TQ1TQ2_SUPPGRP" {
    OUL_R24_TQ1TQ2_SUPPGRP messageInstance = {tq1:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "ORF_R04_TQ1TQ2_SUPPGRP" {
    ORF_R04_TQ1TQ2_SUPPGRP messageInstance = {tq1:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "SUR_P09_PSHPDC_SUPPGRP" {
    SUR_P09_PSHPDC_SUPPGRP messageInstance = {psh:{}, pdc:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R23_PIDPD1NTE_SUPPGRP" {
    OUL_R23_PIDPD1NTE_SUPPGRP messageInstance = {pid:{}};
    return messageInstance;
...
if segmentComponentName == "RRI_I12_PATIENT_VISIT" {
    ...
    return messageInstance;
} else if segmentComponentName == "PGL_PC6_OBR_SUPPGRP" {
    PGL_PC6_OBR_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OSR_Q06_OBRRQDRQ1RXOODSODT_SUPPGRP" {
    OSR_Q06_OBRRQDRQ1RXOODSODT_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "PPT_PCL_OBR_SUPPGRP" {
    PPT_PCL_OBR_SUPPGRP messageInstance = {};
    return messageInstance;
} else if segmentComponentName == "RSP_Z88_OBSERVATION" {
    RSP_Z88_OBSERVATION messageInstance = {};
    return messageInstance;
} else if segmentComponentName == "ORR_O02_OBRRQDRQ1RXOODSODT_SUPPGRP" {
    ORR_O02_OBRRQDRQ1RXOODSODT_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "PPR_PC1_OBR_SUPPGRP" {
    PPR_PC1_OBR_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "SUR_P09_FACPSHPDCPSHFACPDCNTEED_SUPPGRP" {
    SUR_P09_FACPSHPDCPSHFACPDCNTEED_SUPPGRP messageInstance = {psh:{}, fac:{}, ed:{}};
    return messageInstance;
    ...
    QVR_Q17_QBP messageInstance = {anyhl7segment:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "DOC_T12_EVNPIDPV1TXAOBX_SUPPGRP" {
    DOC_T12_EVNPIDPV1TXAOBX_SUPPGRP messageInstance = {pid:{}, pv1:{}, txa:{}};
    return messageInstance;
...
if segmentComponentName == "SQR_S25_PATIENT" {
    ...
    return messageInstance;
} else if segmentComponentName == "MDM_T02_OBXNTE_SUPPGRP" {
    MDM_T02_OBXNTE_SUPPGRP messageInstance = {obx:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "PPP_PCB_OBR_SUPPGRP" {
    PPP_PCB_OBR_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "PTR_PCF_OBR_SUPPGRP" {
    PTR_PCF_OBR_SUPPGRP messageInstance = {};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R24_OBXTCDSIDNTE_SUPPGRP" {
    OUL_R24_OBXTCDSIDNTE_SUPPGRP messageInstance = {obx:{}};
    return messageInstance;
    ...
    MFR_M01_MF_QUERY messageInstance = {anyhl7segment:{}, mfe:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "ORF_R04_PIDNTE_SUPPGRP" {
    ORF_R04_PIDNTE_SUPPGRP messageInstance = {pid:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "CSU_C09_RXARXR_SUPPGRP" {
    CSU_C09_RXARXR_SUPPGRP messageInstance = {rxa:{}, rxr:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "OUL_R24_PIDPD1NTE_SUPPGRP" {
    OUL_R24_PIDPD1NTE_SUPPGRP messageInstance = {pid:{}};
    return messageInstance;
    ...
    return messageInstance;
} else if segmentComponentName == "SUR_P09_FACPDCNTE_SUPPGRP" {
    SUR_P09_FACPDCNTE_SUPPGRP messageInstance = {fac:{}, pdc:{}, nte:{}};
    return messageInstance;

    ...
    ,groups: {
        ...
        "RPA_I08_PROCEDURE": {
            ...
            segments: {
                ...
                "RPA_I08_AUTHORIZATION_2": {name: "RPA_I08_AUTHORIZATION_2", maxReps: 1, required: false, segmentType: typeof RPA_I08_AUTHORIZATION_2}
            }
        },
        "RPA_I08_OBSERVATION": {
            maxReps: -1,
...
public type RPA_I08 record {
    *hl7v2:Message;
    ...
    AL1[] al1 = [];
    NTE[] nte = [];
    RPA_I08_AUTHORIZATION_1[] authorization_1 = [{aut:{}}];

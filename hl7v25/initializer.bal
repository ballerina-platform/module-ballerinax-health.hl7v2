...
function init() {
    readonly & hl7v2:HL7Package package = {
        name: "HL7v25",
        hl7Version: "2.5",
        parserCreator: createHL7v25Parser,
        encoderCreator: createHL7v25Encoder,
        parserUtils: {
    ...
    log:printDebug("HL7 v2.5 Package Initialized");
}

# Function to create hl7v2:Parser implementation for HL7 v2.5.
...
public isolated function createHL7v25Parser() returns hl7v2:Parser {
    HL7v25Parser parser = new();
    return parser;
}
...
public isolated function createHL7v25Encoder() returns hl7v2:Encoder {
    HL7v25Encoder encoder = new();
    return encoder;
}
...
# + msh - MSH Segment
# + evn - EVN Segment
# + patient - ADT_A41_PATIENT Segment Group
@hl7v2:MessageDefinition {
    orderedSegments: {
        "MSH": [{name: "MSH", maxReps: 1, required: false}],
        "EVN": [{name: "EVN", maxReps: 1, required: false}],
        "MRG": [{name: "MRG", maxReps: 1, required: false, segmentComponentName: "ADT_A41_PATIENT"}],
        "PID": [{name: "PID", maxReps: 1, required: false, segmentComponentName: "ADT_A41_PATIENT"}],
        "PV1": [{name: "PV1", maxReps: 1, required: false, segmentComponentName: "ADT_A41_PATIENT"}],
        "PD1": [{name: "PD1", maxReps: 1, required: false, segmentComponentName: "ADT_A41_PATIENT"}]
    }
,
    segments: {
...
public type ADT_A41 record {
    *hl7v2:Message;
    ...
    MSH msh;
    EVN evn;
    ADT_A41_PATIENT[] patient = [{pid:{}, mrg:{}}];
};

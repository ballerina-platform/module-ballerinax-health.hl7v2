...
@hl7v2:MessageDefinition {
    orderedSegments: {
        ...
        "PR1": [{name: "PR1", maxReps: 1, required: false, segmentComponentName: "ADT_A07_PROCEDURE"}],
        "ROL": [{name: "ROL", maxReps: -1, required: false, segmentComponentName: "ADT_A07_PROCEDURE"}],
        "GT1": [{name: "GT1", maxReps: -1, required: false}],
        "IN2": [{name: "IN2", maxReps: 1, required: false, segmentComponentName: "ADT_A07_INSURANCE"}],
        "IN1": [{name: "IN1", maxReps: 1, required: false, segmentComponentName: "ADT_A07_INSURANCE"}],
        "IN3": [{name: "IN3", maxReps: 1, required: false, segmentComponentName: "ADT_A07_INSURANCE"}],

...
# HL7 v2.3 message encoder implementation.
isolated class HL7v23Encoder {
    *hl7v2:Encoder;

    # Encodes a HL7 v2.3 message to MLLP format.
    #
    # + message - The HL7 message to be encoded
    # + return - The encoded message as a byte array or an `hl7v2:HL7Error` if an error occurred

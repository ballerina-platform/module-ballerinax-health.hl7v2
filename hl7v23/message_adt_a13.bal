...
public const ADT_A13_MESSAGE_TYPE = "ADT_A13";
...
# + ub1 - UB1 Segment
# + ub2 - UB2 Segment
# + procedure - ADT_A13_PROCEDURE Segment Group
# + insurance - ADT_A13_INSURANCE Segment Group
@hl7v2:MessageDefinition {
        ...
        "PR1": [{name: "PR1", maxReps: 1, required: false, segmentComponentName: "ADT_A13_PROCEDURE"}],
        "ROL": [{name: "ROL", maxReps: -1, required: false, segmentComponentName: "ADT_A13_PROCEDURE"}],
        "GT1": [{name: "GT1", maxReps: -1, required: false}],
        "IN2": [{name: "IN2", maxReps: 1, required: false, segmentComponentName: "ADT_A13_INSURANCE"}],
        "IN1": [{name: "IN1", maxReps: 1, required: false, segmentComponentName: "ADT_A13_INSURANCE"}],
        "IN3": [{name: "IN3", maxReps: 1, required: false, segmentComponentName: "ADT_A13_INSURANCE"}],
...
public type ADT_A13 record {
    *hl7v2:Message;
    string name = ADT_A13_MESSAGE_TYPE;
    MSH msh;
    EVN evn;
    PID pid;
    PD1 pd1?;
    ...
    DG1[] dg1 = [];
    DRG drg?;
    ADT_A13_PROCEDURE[] procedure = [{pr1:{}}];
    GT1[] gt1 = [];
    ADT_A13_INSURANCE[] insurance = [{in1:{}}];
    ACC acc?;
    UB1 ub1?;
    UB2 ub2?;
};
